package com.imooc.rabbit.config.database;
...
public class DruidDataSourceConfig {
    private static Logger logger = LoggerFactory.getLogger( com.imooc.rabbit.config.database.DruidDataSourceConfig.class);
    ...
    public DataSource dataSource() throws SQLException {
        ...
        ds.setTestWhileIdle(druidSettings.getTestWhileIdle());
        ds.setTestOnBorrow(druidSettings.getTestOnBorrow());
        ds.setTestOnReturn(druidSettings.getTestOnReturn());
        ds.setPoolPreparedStatements(druidSettings.getPoolPreparedStatements());
